...
! JP ccccccccccccccccccccccccccccccccccccccccc
          integer, parameter :: nqmax0=30 !number of q to sample for each l
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!c               write(*,*) 'at z = ',real(CP%Transfer%redshifts(j)), ' sigma8 (all matter)=', real(MTrans%sigma_8(j,in))
		write(*,*) real(MTrans%sigma_8(j,in))
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
            end do
           end do
